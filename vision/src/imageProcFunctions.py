...
cv.CreateTrackbar("S Lower:", "Red:", 50, 100, onSLowerRChange)
cv.CreateTrackbar("V Lower:", "Red:", 50, 100, onVLowerRChange)
cv.CreateTrackbar("H Upper:", "Red:", 5, 100, onHUpperRChange)
cv.CreateTrackbar("S Upper:", "Red:", 100, 100, onSUpperRChange)
cv.CreateTrackbar("V Upper:", "Red:", 100, 100, onVUpperRChange)

cv.CreateTrackbar("H Lower:", "Blue:", 30, 100, onHLowerBChange)
cv.CreateTrackbar("S Lower:", "Blue:", 25, 100, onSLowerBChange)
cv.CreateTrackbar("V Lower:", "Blue:", 25, 100, onVLowerBChange)
cv.CreateTrackbar("H Upper:", "Blue:", 80, 100, onHUpperBChange)
cv.CreateTrackbar("S Upper:", "Blue:", 100, 100, onSUpperBChange)
cv.CreateTrackbar("V Upper:", "Blue:", 100, 100, onVUpperBChange)

cv.CreateTrackbar("H Lower:", "Yellow:", 9, 100, onHLowerYChange)
cv.CreateTrackbar("S Lower:", "Yellow:", 45, 100, onSLowerYChange)
cv.CreateTrackbar("V Lower:", "Yellow:", 50, 100, onVLowerYChange)
cv.CreateTrackbar("H Upper:", "Yellow:", 20, 100, onHUpperYChange)
cv.CreateTrackbar("S Upper:", "Yellow:", 100, 100, onSUpperYChange)
cv.CreateTrackbar("V Upper:", "Yellow:", 100, 100, onVUpperYChange)
...
cv.CreateTrackbar("H Upper:", "Black:", 100, 100, onHUpperBkChange)
cv.CreateTrackbar("S Upper:", "Black:", 100, 100, onSUpperBkChange)
cv.CreateTrackbar("V Upper:", "Black:", 45, 100, onVUpperBkChange)
