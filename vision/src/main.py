...
def draw_on_image(image, center_points, other_points):
    ...
    cv.Circle(image, center_points[1][0], 19, cv.RGB(0,0,255), -1)
    cv.Circle(image, center_points[2][0], 19, cv.RGB(0,255,255), -1)
...
#    yellow_white = (int(yellow_white[0]) + yellow_crop_rect[0] - 3, int(yellow_white[1]) + yellow_crop_rect[1] - 50)
  ...
  #  stdscr.addstr(3,0, "Moved:" + str(blue_center))# +str(euclid_distance(old_blue_position[0], blue_center[0])))
   # stdscr.addstr(4,0, "Speed:" + str(calculate_speed(old_blue_position[0], blue_center[0], time_diff)))
  ...
  #  stdscr.addstr(9,0, "Moved:" + str(euclid_distance(old_yellow_position[0], yellow_center[0])))
   # stdscr.addstr(10,0, "Speed:" + str(calculate_speed(old_yellow_position[0], yellow_center[0], time_diff)))
