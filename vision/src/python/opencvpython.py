...
def process(img, colour):
    ...
    if (colour == "RED"):
        cv.InRangeS(hsv, cv.Scalar(0.00 * 256, 0.50 * 256, 0.50 * 256),
                cv.Scalar(0.05 * 256, 1.00 * 256, 1.00 * 256), mask)
    elif (colour == "BLUE"):
        cv.InRangeS(hsv, cv.Scalar(0.30 * 256, 0.30 * 256, 0.30 * 256),
                cv.Scalar(0.80 * 256, 1.00 * 256, 1.00 * 256), mask)
    elif (colour == "YELLOW"):
        cv.InRangeS(hsv, cv.Scalar(0.10 * 256, 0.45 * 256, 0.50 * 256),
                cv.Scalar(0.20 * 256, 1.00 * 256, 1.00 * 256), mask)
    ...
    contours = cv.FindContours(contourImage, storage, cv.CV_RETR_EXTERNAL,
